...
import { PlatformRaw, Contract } from "../types";
...
import * as coinflow from "./coinflow";
...
import * as fluxbot from "./fluxbot";
...
export const contracts: Contract[] = [
  ...alldomains.contracts.map((c) => ({ ...c, platformId: alldomains.platform.id })),
  ...ample.contracts.map((c) => ({ ...c, platformId: ample.platform.id })),
  ...antfun.contracts.map((c) => ({ ...c, platformId: antfun.platform.id })),
  ...asgardfi.contracts.map((c) => ({ ...c, platformId: asgardfi.platform.id })),
  ...aurory.contracts.map((c) => ({ ...c, platformId: aurory.platform.id })),
  ...axiom.contracts.map((c) => ({ ...c, platformId: axiom.platform.id })),
  ...backpack.contracts.map((c) => ({ ...c, platformId: backpack.platform.id })),
  ...backwoods.contracts.map((c) => ({ ...c, platformId: backwoods.platform.id })),
  ...
  ...binance.contracts.map((c) => ({ ...c, platformId: binance.platform.id })),
  ...blaze.contracts.map((c) => ({ ...c, platformId: blaze.platform.id })),
  ...bloom.contracts.map((c) => ({ ...c, platformId: bloom.platform.id })),
  ...blueshift.contracts.map((c) => ({ ...c, platformId: blueshift.platform.id })),
  ...bonfida.contracts.map((c) => ({ ...c, platformId: bonfida.platform.id })),
  ...bonkbot.contracts.map((c) => ({ ...c, platformId: bonkbot.platform.id })),
  ...bonkfun.contracts.map((c) => ({ ...c, platformId: bonkfun.platform.id })),
  ...bonkrewards.contracts.map((c) => ({ ...c, platformId: bonkrewards.platform.id })),
  ...boop.contracts.map((c) => ({ ...c, platformId: boop.platform.id })),
  ...bouncebit.contracts.map((c) => ({ ...c, platformId: bouncebit.platform.id })),
  ...brale.contracts.map((c) => ({ ...c, platformId: brale.platform.id })),
  ...brawl.contracts.map((c) => ({ ...c, platformId: brawl.platform.id })),
  ...
  ...bulktrade.contracts.map((c) => ({ ...c, platformId: bulktrade.platform.id })),
  ...burnandclaim.contracts.map((c) => ({ ...c, platformId: burnandclaim.platform.id })),
  ...
  ...chopcorp.contracts.map((c) => ({ ...c, platformId: chopcorp.platform.id })),
  ...circuit.contracts.map((c) => ({ ...c, platformId: circuit.platform.id })),
  ...circular.contracts.map((c) => ({ ...c, platformId: circular.platform.id })),
  ...citrus.contracts.map((c) => ({ ...c, platformId: citrus.platform.id })),
  ...claynosaurz.contracts.map((c) => ({ ...c, platformId: claynosaurz.platform.id })),
  ...coinbase.contracts.map((c) => ({ ...c, platformId: coinbase.platform.id })),
  ...coinflow.contracts.map((c) => ({ ...c, platformId: coinflow.platform.id })),
  ...coinmarketcap.contracts.map((c) => ({ ...c, platformId: coinmarketcap.platform.id })),
  ...collectorcrypt.contracts.map((c) => ({ ...c, platformId: collectorcrypt.platform.id })),
  ...cooladdress.contracts.map((c) => ({ ...c, platformId: cooladdress.platform.id })),
  ...crossmint.contracts.map((c) => ({ ...c, platformId: crossmint.platform.id })),
  ...cudis.contracts.map((c) => ({ ...c, platformId: cudis.platform.id })),
  ...cushion.contracts.map((c) => ({ ...c, platformId: cushion.platform.id })),
  ...cyberfrogs.contracts.map((c) => ({ ...c, platformId: cyberfrogs.platform.id })),
  ...cytonic.contracts.map((c) => ({ ...c, platformId: cytonic.platform.id })),
  ...daosdotfun.contracts.map((c) => ({ ...c, platformId: daosdotfun.platform.id })),
  ...debridge.contracts.map((c) => ({ ...c, platformId: debridge.platform.id })),
  ...defiland.contracts.map((c) => ({ ...c, platformId: defiland.platform.id })),
  ...defituna.contracts.map((c) => ({ ...c, platformId: defituna.platform.id })),
  ...degenapeacademy.contracts.map((c) => ({ ...c, platformId: degenapeacademy.platform.id })),
  ...degencoinflip.contracts.map((c) => ({ ...c, platformId: degencoinflip.platform.id })),
  ...degods.contracts.map((c) => ({ ...c, platformId: degods.platform.id })),
  ...deriverse.contracts.map((c) => ({ ...c, platformId: deriverse.platform.id })),
  ...dflow.contracts.map((c) => ({ ...c, platformId: dflow.platform.id })),
  ...diversifi.contracts.map((c) => ({ ...c, platformId: diversifi.platform.id })),
  ...divvy.contracts.map((c) => ({ ...c, platformId: divvy.platform.id })),
  ...domin8.contracts.map((c) => ({ ...c, platformId: domin8.platform.id })),
  ...doubleup.contracts.map((c) => ({ ...c, platformId: doubleup.platform.id })),
  ...
  ...elemental.contracts.map((c) => ({ ...c, platformId: elemental.platform.id })),
  ...ensofi.contracts.map((c) => ({ ...c, platformId: ensofi.platform.id })),
  ...epicentral.contracts.map((c) => ({ ...c, platformId: epicentral.platform.id })),
  ...eternalstakefinance.contracts.map((c) => ({ ...c, platformId: eternalstakefinance.platform.id })),
  ...exponent.contracts.map((c) => ({ ...c, platformId: exponent.platform.id })),
  ...famousfoxfederation.contracts.map((c) => ({ ...c, platformId: famousfoxfederation.platform.id })),
  ...fastpoker.contracts.map((c) => ({ ...c, platformId: fastpoker.platform.id })),
  ...flash.contracts.map((c) => ({ ...c, platformId: flash.platform.id })),
  ...flexlend.contracts.map((c) => ({ ...c, platformId: flexlend.platform.id })),
  ...flowmatic.contracts.map((c) => ({ ...c, platformId: flowmatic.platform.id })),
  ...fluxbeam.contracts.map((c) => ({ ...c, platformId: fluxbeam.platform.id })),
  ...fluxbot.contracts.map((c) => ({ ...c, platformId: fluxbot.platform.id })),
  ...fragmetric.contracts.map((c) => ({ ...c, platformId: fragmetric.platform.id })),
  ...fuse.contracts.map((c) => ({ ...c, platformId: fuse.platform.id })),
  ...futarchy.contracts.map((c) => ({ ...c, platformId: futarchy.platform.id })),
  ...futard.contracts.map((c) => ({ ...c, platformId: futard.platform.id })),
  ...gamma.contracts.map((c) => ({ ...c, platformId: gamma.platform.id })),
  ...garden.contracts.map((c) => ({ ...c, platformId: garden.platform.id })),
  ...gauntlet.contracts.map((c) => ({ ...c, platformId: gauntlet.platform.id })),
  ...gecko.contracts.map((c) => ({ ...c, platformId: gecko.platform.id })),
  ...genesysgo.contracts.map((c) => ({ ...c, platformId: genesysgo.platform.id })),
  ...
  ...gofurs.contracts.map((c) => ({ ...c, platformId: gofurs.platform.id })),
  ...goki.contracts.map((c) => ({ ...c, platformId: goki.platform.id })),
  ...graphite.contracts.map((c) => ({ ...c, platformId: graphite.platform.id })),
  ...grass.contracts.map((c) => ({ ...c, platformId: grass.platform.id })),
  ...growcorp.contracts.map((c) => ({ ...c, platformId: growcorp.platform.id })),
  ...
  ...hawksight.contracts.map((c) => ({ ...c, platformId: hawksight.platform.id })),
  ...hedgehog.contracts.map((c) => ({ ...c, platformId: hedgehog.platform.id })),
  ...helio.contracts.map((c) => ({ ...c, platformId: helio.platform.id })),
  ...helium.contracts.map((c) => ({ ...c, platformId: helium.platform.id })),
  ...helius.contracts.map((c) => ({ ...c, platformId: helius.platform.id })),
  ...honeyland.contracts.map((c) => ({ ...c, platformId: honeyland.platform.id })),
  ...hubra.contracts.map((c) => ({ ...c, platformId: hubra.platform.id })),
  ...huma.contracts.map((c) => ({ ...c, platformId: huma.platform.id })),
  ...humidifi.contracts.map((c) => ({ ...c, platformId: humidifi.platform.id })),
  ...
  ...jupiterExchange.contracts.map((c) => ({ ...c, platformId: jupiterExchange.platform.id })),
  ...jupiterGovernance.contracts.map((c) => ({ ...c, platformId: jupiterGovernance.platform.id })),
  ...jupiterJupuary.contracts.map((c) => ({ ...c, platformId: jupiterJupuary.platform.id })),
  ...jupiterLaunchpad.contracts.map((c) => ({ ...c, platformId: jupiterLaunchpad.platform.id })),
  ...jupiterMobile.contracts.map((c) => ({ ...c, platformId: jupiterMobile.platform.id })),
  ...jupiterOfferbook.contracts.map((c) => ({ ...c, platformId: jupiterOfferbook.platform.id })),
  ...jupiterPm.contracts.map((c) => ({ ...c, platformId: jupiterPm.platform.id })),
  ...jupiterWallet.contracts.map((c) => ({ ...c, platformId: jupiterWallet.platform.id })),
  ...kamino.contracts.map((c) => ({ ...c, platformId: kamino.platform.id })),
  ...kast.contracts.map((c) => ({ ...c, platformId: kast.platform.id })),
  ...knightrade.contracts.map((c) => ({ ...c, platformId: knightrade.platform.id })),
  ...kormos.contracts.map((c) => ({ ...c, platformId: kormos.platform.id })),
  ...kyros.contracts.map((c) => ({ ...c, platformId: kyros.platform.id })),
  ...lavarage.contracts.map((c) => ({ ...c, platformId: lavarage.platform.id })),
  ...
  ...loopscale.contracts.map((c) => ({ ...c, platformId: loopscale.platform.id })),
  ...
  ...madbears.contracts.map((c) => ({ ...c, platformId: madbears.platform.id })),
  ...madlads.contracts.map((c) => ({ ...c, platformId: madlads.platform.id })),
  ...maestro.contracts.map((c) => ({ ...c, platformId: maestro.platform.id })),
  ...magiceden.contracts.map((c) => ({ ...c, platformId: magiceden.platform.id })),
  ...magna.contracts.map((c) => ({ ...c, platformId: magna.platform.id })),
  ...manifest.contracts.map((c) => ({ ...c, platformId: manifest.platform.id })),
  ...marginfi.contracts.map((c) => ({ ...c, platformId: marginfi.platform.id })),
  ...marinade.contracts.map((c) => ({ ...c, platformId: marinade.platform.id })),
  ...maxbid.contracts.map((c) => ({ ...c, platformId: maxbid.platform.id })),
  ...mayan.contracts.map((c) => ({ ...c, platformId: mayan.platform.id })),
  ...melee.contracts.map((c) => ({ ...c, platformId: melee.platform.id })),
  ...metaplex.contracts.map((c) => ({ ...c, platformId: metaplex.platform.id })),
  ...metengine.contracts.map((c) => ({ ...c, platformId: metengine.platform.id })),
  ...meteora.contracts.map((c) => ({ ...c, platformId: meteora.platform.id })),
  ...mintech.contracts.map((c) => ({ ...c, platformId: mintech.platform.id })),
  ...mixoor.contracts.map((c) => ({ ...c, platformId: mixoor.platform.id })),
  ...mooncake.contracts.map((c) => ({ ...c, platformId: mooncake.platform.id })),
  ...moonpay.contracts.map((c) => ({ ...c, platformId: moonpay.platform.id })),
  ...moonwalk.contracts.map((c) => ({ ...c, platformId: moonwalk.platform.id })),
  ...mysticdao.contracts.map((c) => ({ ...c, platformId: mysticdao.platform.id })),
  ...nativeStake.contracts.map((c) => ({ ...c, platformId: nativeStake.platform.id })),
  ...
  ...nufi.contracts.map((c) => ({ ...c, platformId: nufi.platform.id })),
  ...okaybears.contracts.map((c) => ({ ...c, platformId: okaybears.platform.id })),
  ...okx.contracts.map((c) => ({ ...c, platformId: okx.platform.id })),
  ...omni.contracts.map((c) => ({ ...c, platformId: omni.platform.id })),
  ...omnipair.contracts.map((c) => ({ ...c, platformId: omnipair.platform.id })),
  ...ondoFinance.contracts.map((c) => ({ ...c, platformId: ondoFinance.platform.id })),
  ...onre.contracts.map((c) => ({ ...c, platformId: onre.platform.id })),
  ...oobeprotocol.contracts.map((c) => ({ ...c, platformId: oobeprotocol.platform.id })),
  ...oobit.contracts.map((c) => ({ ...c, platformId: oobit.platform.id })),
  ...openbook.contracts.map((c) => ({ ...c, platformId: openbook.platform.id })),
  ...orbmarkets.contracts.map((c) => ({ ...c, platformId: orbmarkets.platform.id })),
  ...orca.contracts.map((c) => ({ ...c, platformId: orca.platform.id })),
  ...orderly.contracts.map((c) => ({ ...c, platformId: orderly.platform.id })),
  ...ore.contracts.map((c) => ({ ...c, platformId: ore.platform.id })),
  ...oreblue.contracts.map((c) => ({ ...c, platformId: oreblue.platform.id })),
  ...oresupply.contracts.map((c) => ({ ...c, platformId: oresupply.platform.id })),
  ...oro.contracts.map((c) => ({ ...c, platformId: oro.platform.id })),
  ...pacifica.contracts.map((c) => ({ ...c, platformId: pacifica.platform.id })),
  ...packs.contracts.map((c) => ({ ...c, platformId: packs.platform.id })),
  ...pancakeswap.contracts.map((c) => ({ ...c, platformId: pancakeswap.platform.id })),
  ...parcl.contracts.map((c) => ({ ...c, platformId: parcl.platform.id })),
  ...paypal.contracts.map((c) => ({ ...c, platformId: paypal.platform.id })),
  ...perena.contracts.map((c) => ({ ...c, platformId: perena.platform.id })),
  ...phantom.contracts.map((c) => ({ ...c, platformId: phantom.platform.id })),
  ...phettagotchi.contracts.map((c) => ({ ...c, platformId: phettagotchi.platform.id })),
  ...phoenix.contracts.map((c) => ({ ...c, platformId: phoenix.platform.id })),
  ...photofinish.contracts.map((c) => ({ ...c, platformId: photofinish.platform.id })),
  ...photon.contracts.map((c) => ({ ...c, platformId: photon.platform.id })),
  ...phygitals.contracts.map((c) => ({ ...c, platformId: phygitals.platform.id })),
  ...piggybank.contracts.map((c) => ({ ...c, platformId: piggybank.platform.id })),
  ...playsolana.contracts.map((c) => ({ ...c, platformId: playsolana.platform.id })),
  ...pluto.contracts.map((c) => ({ ...c, platformId: pluto.platform.id })),
  ...portalBridge.contracts.map((c) => ({ ...c, platformId: portalBridge.platform.id })),
  ...portals.contracts.map((c) => ({ ...c, platformId: portals.platform.id })),
  ...printr.contracts.map((c) => ({ ...c, platformId: printr.platform.id })),
  ...privacycash.contracts.map((c) => ({ ...c, platformId: privacycash.platform.id })),
  ...privy.contracts.map((c) => ({ ...c, platformId: privy.platform.id })),
  ...project0.contracts.map((c) => ({ ...c, platformId: project0.platform.id })),
  ...pudgy.contracts.map((c) => ({ ...c, platformId: pudgy.platform.id })),
  ...pumpfun.contracts.map((c) => ({ ...c, platformId: pumpfun.platform.id })),
  ...pumpkin.contracts.map((c) => ({ ...c, platformId: pumpkin.platform.id })),
  ...pumpswap.contracts.map((c) => ({ ...c, platformId: pumpswap.platform.id })),
  ...
  ...realms.contracts.map((c) => ({ ...c, platformId: realms.platform.id })),
  ...reap.contracts.map((c) => ({ ...c, platformId: reap.platform.id })),
  ...recc.contracts.map((c) => ({ ...c, platformId: recc.platform.id })),
  ...refihub.contracts.map((c) => ({ ...c, platformId: refihub.platform.id })),
  ...reflect.contracts.map((c) => ({ ...c, platformId: reflect.platform.id })),
  ...reflex.contracts.map((c) => ({ ...c, platformId: reflex.platform.id })),
  ...relay.contracts.map((c) => ({ ...c, platformId: relay.platform.id })),
  ...renzo.contracts.map((c) => ({ ...c, platformId: renzo.platform.id })),
  ...rise.contracts.map((c) => ({ ...c, platformId: rise.platform.id })),
  ...robinhood.contracts.map((c) => ({ ...c, platformId: robinhood.platform.id })),
  ...runemine.contracts.map((c) => ({ ...c, platformId: runemine.platform.id })),
  ...sanctum.contracts.map((c) => ({ ...c, platformId: sanctum.platform.id })),
  ...save.contracts.map((c) => ({ ...c, platformId: save.platform.id })),
  ...sendai.contracts.map((c) => ({ ...c, platformId: sendai.platform.id })),
  ...sharky.contracts.map((c) => ({ ...c, platformId: sharky.platform.id })),
  ...slabdrop.contracts.map((c) => ({ ...c, platformId: slabdrop.platform.id })),
  ...smb.contracts.map((c) => ({ ...c, platformId: smb.platform.id })),
  ...solanaExplorer.contracts.map((c) => ({ ...c, platformId: solanaExplorer.platform.id })),
  ...solanaFm.contracts.map((c) => ({ ...c, platformId: solanaFm.platform.id })),
  ...solana.contracts.map((c) => ({ ...c, platformId: solana.platform.id })),
  ...solanabeach.contracts.map((c) => ({ ...c, platformId: solanabeach.platform.id })),
  ...solanaid.contracts.map((c) => ({ ...c, platformId: solanaid.platform.id })),
  ...solanamobile.contracts.map((c) => ({ ...c, platformId: solanamobile.platform.id })),
  ...solanatracker.contracts.map((c) => ({ ...c, platformId: solanatracker.platform.id })),
  ...solayer.contracts.map((c) => ({ ...c, platformId: solayer.platform.id })),
  ...solcard.contracts.map((c) => ({ ...c, platformId: solcard.platform.id })),
  ...solcasino.contracts.map((c) => ({ ...c, platformId: solcasino.platform.id })),
  ...solflare.contracts.map((c) => ({ ...c, platformId: solflare.platform.id })),
  ...solincinerator.contracts.map((c) => ({ ...c, platformId: solincinerator.platform.id })),
  ...
  ...solstice.contracts.map((c) => ({ ...c, platformId: solstice.platform.id })),
  ...
  ...stakewiz.contracts.map((c) => ({ ...c, platformId: stakewiz.platform.id })),
  ...staratlas.contracts.map((c) => ({ ...c, platformId: staratlas.platform.id })),
  ...streamflow.contracts.map((c) => ({ ...c, platformId: streamflow.platform.id })),
  ...sunrise.contracts.map((c) => ({ ...c, platformId: sunrise.platform.id })),
  ...switchboard.contracts.map((c) => ({ ...c, platformId: switchboard.platform.id })),
  ...symmetry.contracts.map((c) => ({ ...c, platformId: symmetry.platform.id })),
  ...tender.contracts.map((c) => ({ ...c, platformId: tender.platform.id })),
  ...tensor.contracts.map((c) => ({ ...c, platformId: tensor.platform.id })),
  ...thevault.contracts.map((c) => ({ ...c, platformId: thevault.platform.id })),
  ...threshold.contracts.map((c) => ({ ...c, platformId: threshold.platform.id })),
  ...tibanelabs.contracts.map((c) => ({ ...c, platformId: tibanelabs.platform.id })),
  ...tiplink.contracts.map((c) => ({ ...c, platformId: tiplink.platform.id })),
  ...titan.contracts.map((c) => ({ ...c, platformId: titan.platform.id })),
  ...tramplin.contracts.map((c) => ({ ...c, platformId: tramplin.platform.id })),
  ...trepa.contracts.map((c) => ({ ...c, platformId: trepa.platform.id })),
  ...triad.contracts.map((c) => ({ ...c, platformId: triad.platform.id })),
  ...tribeca.contracts.map((c) => ({ ...c, platformId: tribeca.platform.id })),
  ...trojan.contracts.map((c) => ({ ...c, platformId: trojan.platform.id })),
  ...trustfun.contracts.map((c) => ({ ...c, platformId: trustfun.platform.id })),
  ...tuktuk.contracts.map((c) => ({ ...c, platformId: tuktuk.platform.id })),
  ...turbinecash.contracts.map((c) => ({ ...c, platformId: turbinecash.platform.id })),
  ...
  ...whalesmarket.contracts.map((c) => ({ ...c, platformId: whalesmarket.platform.id })),
  ...wink.contracts.map((c) => ({ ...c, platformId: wink.platform.id })),
  ...wormhole.contracts.map((c) => ({ ...c, platformId: wormhole.platform.id })),
  ...wzrd.contracts.map((c) => ({ ...c, platformId: wzrd.platform.id })),
  ...
  ...zenrock.contracts.map((c) => ({ ...c, platformId: zenrock.platform.id })),
  ...zeus.contracts.map((c) => ({ ...c, platformId: zeus.platform.id })),
  ...zinc.contracts.map((c) => ({ ...c, platformId: zinc.platform.id })),
  ...zora.contracts.map((c) => ({ ...c, platformId: zora.platform.id })),
];
